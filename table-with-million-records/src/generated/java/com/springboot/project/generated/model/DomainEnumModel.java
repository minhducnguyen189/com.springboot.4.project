...
public enum DomainEnumModel implements Serializable {
  ...
  @JsonCreator
  public static DomainEnumModel fromValue(String value) {
    for (DomainEnumModel b : DomainEnumModel.values()) {
