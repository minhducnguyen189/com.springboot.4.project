...
public class LoginUserService {
    ...
    public void upsertLoginUser(LoginUserModel loginUserModelRequest) {
        Optional<LoginUserEntity> loginUserEntityOptional = this.loginUserRepository
                .findByEmail(loginUserModelRequest.getEmail());
        if (loginUserEntityOptional.isPresent()) {
            ...
            LoginUserEntity loginUser = LoginUserMapper.MAPPER.toLoginUserEntity(loginUserModelRequest);
    ...
    public LoginUserResponseModel getCurrentLoginUser() {
        ...
        if (Objects.nonNull(authentication)
            ...
            Optional<LoginUserEntity> loginUserOpt = this.loginUserRepository.findByEmail(principal.getEmail());
