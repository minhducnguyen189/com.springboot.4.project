...
public class BankAccountService {
        ...
        public BankAccountFilterResponseModel filterBankAccounts(
                ...
                Example<BankAccountEntity> bankAccountEntityExample = this.buildBankAccountExample(filterRequest);
                Specification<BankAccountEntity> specification = SpecificationHelper.init(bankAccountEntityExample);
        ...
        private Example<BankAccountEntity> buildBankAccountExample(
                ...
                BankAccountEntity bankAccount = BankAccountMapper.MAPPER
                                .toBankAccountEntityFromExample(filterRequestModel);
